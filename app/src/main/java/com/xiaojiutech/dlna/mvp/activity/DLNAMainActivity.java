...
public class DLNAMainActivity extends BaseActivity {
	...
	private void initView() {
		btn_main.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Toast.makeText(DLNAMainActivity.this, "start dlna service to find dlna devices.", Toast.LENGTH_SHORT).show();
				startDLNAService();
				mDevices = DLNAContainer.getInstance().getDevices();
				Log.d(TAG, "mDevices size:" + mDevices.size());
				refresh();
			}
		});
